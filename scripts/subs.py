...
for align_sv_type in sv_types:
    dataset = align.generate_dataset(default_ref, sv_type=align_sv_type, sv_nbr=5, length_mean=9000, length_sd=7000, depth=20, chromosome_nbr=1, force=True)
