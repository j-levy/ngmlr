...
for align_sv_type in sv_types:
    for length in lengths_mean:
        dataset = align.generate_dataset(default_ref, sv_type=align_sv_type, sv_nbr=sv_nbr, length_mean=length, length_sd=length_sd, depth=depth, chromosome_nbr=chromosome_nbr, force=force)
